...
/**
 * Strings for component 'theme_mada', language 'en'
 *
 * @package   theme_mada
 * @copyright 2011
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
$string['configtitle'] = 'mada Custom Settings';
$string['pluginname'] = 'mada';
$string['region-side-post'] = 'Right';
$string['region-side-pre'] = 'Left';
$string['logo'] = 'Logo';
$string['logodesc'] = 'Please add the URL to your new logo only if you want to replace the default logo for this theme.<br />For your information, the default logo is a JPG image 400px (wide) by 155px (high)';
...
<div class="clearfix">
 <div class="theme_screenshot">
  ...
  <h2>mada</h2>
  <img src="mada/pix/screenshot.jpg" />
 ...
 <div class="theme_description">
  <h2>About</h2>
  <p>mada is a three-column, fluid-width theme coded for Moodle 2.0. It makes use of custom menus that appear below the site title on every page. An added function, which allows users to login and logout, has now been integrated into the custom menu for this theme.</p>
  <h2>Parents</h2>
